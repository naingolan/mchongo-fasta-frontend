...
@Component({
  ...
  styles: [`
    .topbar-brand-icon {
      ...
      filter: drop-shadow(0 2px 8px rgba(43, 106, 255, 0.25));
    }
    .brand-title-sakai {
      font-weight: 800;
      font-size: 1.25rem;
